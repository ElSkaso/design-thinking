# Stage 02: Research And Validation

Validate the problem and synthesize evidence.

## Inputs

| Source | File/Location | Section/Scope | Why |
|--------|--------------|---------------|-----|
| Previous stage | `../01-problem-intake/output/[project-slug]-project-brief.md` | Full file | Problem frame |
| Skill | `../../skills/design-thinking/SKILL.md` | Core workflow and evidence rules | Design thinking standards |
| Shared context | `../../shared/evidence-standards.md` | Full file | Evidence rules |
| Shared context | `../../SOUL.md` | Full file | Workspace credo |
| Reference | `references/research-plan.md` | Full file | Research scope |
...
|------------|---------------|---------------|
| 1 | Research plan and source targets | Whether scope and constraints are right |
